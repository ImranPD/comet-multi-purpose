<!-- Navigation Bar-->
    <header id="topnav">
      <div class="container">
        ...
        <div class="logo">
          <a href="index-2.html">
            <img src="{{URL::to('comet/assets/images/logo_light.png')}}" alt="" class="logo-light">
            <img src="{{URL::to('comet/assets/images/logo_dark.png')}}" alt="" class="logo-dark">
          </a>
        </div>
        <!-- End Logo container-->
                ...
                <ul class="nav product-list">
                  <li>
                    <div class="product-thumbnail">
                      <img src="comet/assets/images/shop/2.jpg" alt="">
                    </div>
                  ...
                  <li>
                    <div class="product-thumbnail">
                      <img src="{{URL::to('comet/assets/images/shop/5.jpg')}}" alt="">
                    </div>
                    <div class="product-summary">
